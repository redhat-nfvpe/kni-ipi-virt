...
export NUM_MASTERS=3 # Number of masters to deploy in the cluster
...
export OCP_VERSION="latest-4.5" # Which OpenShift version to install (see "version" variable discussed here: https://openshift-kni.github.io/baremetal-deploy/latest/Ansible%20Playbook%20Install.html#ansible-playbook-modifying-the-inventoryhosts-file)
export PROJECT_DIR="/home/$KNI_USERNAME/kni-ipi-virt" # Where does this repo live locally?
export PROV_INTF="" # NIC used for provisioning network,, if external nodes (outside the prov host) will be later added
