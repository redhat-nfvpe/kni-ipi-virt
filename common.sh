...
export OCP_VERSION="latest-4.3" # Which OpenShift version to install (see "version" variable discussed here: https://github.com/openshift-kni/baremetal-deploy/tree/master/ansible-ipi-install#modifying-the-inventoryhosts-file)
